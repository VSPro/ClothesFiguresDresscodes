...
const user = {   // Сведения о пользователе, появляющиеся в системе после обработки введённых им данных
    ...
    sizes_2: {   // Предпочтительнее, чем вариант выше
        chest: '34',    // Обхваты в сантиметрах
        waist: '56',        
        hips: '45',
        height: '34',
        shoes: '23'
...
const clothes = {   // Объект товара
    ...
    sizes_2: {    // Предпочтительнее, чем вариант выше
        chest: '45-56',   // Диапазоны обхватов
        waist: '45-56',        
        hips: '45-56',
        height: '34-46',
        shoes: '34-45'
    ...
    forWhom: {
        ...
        importance: 2,      // Числовой индекс, необходимый при подборе цветов одежды. Возможно не нужен
    },
    clothesAppearance: {
...
const photo = {
    ...
    shape: '1A',
    sex: 1,
    tits: 2,    // Включение этого параметра в список под вопросом, так как слишком много придётся искать моделей и делать фотографий
    ageInterval: '',
    skinColor: '',
    hairColor: '',
 ...
 * возраст, размер обуви, кривизна ног и осанки, размер груди.
