...
export default function shapeTypeDetermination({shoulders, waist, hips, height, sex}) {
    ...
    function elongationDetermination(shoulders, height, sex) {
        ...
        if(sex === 'm') {
            if(elongation > elongationFields_M[0] || elongation < elongationFields_M[elongationFields_M.length]) {
                return 0
            }
    ...
    function estimateTypeOfShape(shoulders, waist, hips, height, sex) {
        ...
        if((categoryByMajorSize === 1 || categoryByMajorSize === 2) && (categoryByDegreeOfWidth === 1 || categoryByDegreeOfWidth === 2)) {
            typeOfShape.push('A')
        } else if (categoryByMajorSize === 3 && (categoryByDegreeOfWidth === 1 || categoryByDegreeOfWidth === 2)) {
            typeOfShape.push('B')
        } else if ((categoryByMajorSize === 1 || categoryByMajorSize === 2 || categoryByMajorSize === 3) && categoryByDegreeOfWidth === 3) {
            typeOfShape.push('C')
        } else {
