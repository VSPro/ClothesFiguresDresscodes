...
const featuredPosts = [
  {
    title: 'Типы фиргур',
    date: '',
    description: 'Какие бывают, как определяются типы фигур человека и почему это важно',
    image: 'https://source.unsplash.com/random',
  ...
  },
  {
    ...
    date: '',
    description: 'Какие наряды наиболее уместны в тех или иных случаях и обстановках',
    image: 'https://source.unsplash.com/random',
    imageText: 'Image Text',
  },
  {
    ...
    <React.Fragment>
      ...
      <Container maxWidth="lg">
        ...
        <main>
          ...
          {/* TODO: Replace Grid components to common flex */}
